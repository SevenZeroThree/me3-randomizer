...
/******/ 	return __webpack_require__(__webpack_require__.s = "./JavaScript/javascript.randomizer.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./JavaScript/javascript.randomizer.js":
/*!*********************************************!*\
  !*** ./JavaScript/javascript.randomizer.js ***!
  \*********************************************/
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Data = function () {\n    function Data() {\n        _classCallCheck(this, Data);\n    }\n\n    _createClass(Data, null, [{\n        key: 'saveApiResponse',\n        value: function saveApiResponse() {\n            var sessionKey = 'multiplayerData';\n\n            var data = sessionStorage.getItem(sessionKey);\n            if (data === undefined || data === null) {\n                getDataFromApi().then(function (response) {\n                    sessionStorage.setItem(sessionKey, JSON.stringify(response.data));\n                });\n            }\n        }\n    }, {\n        key: 'getMultiplayerData',\n        value: function getMultiplayerData() {\n            var sessionKey = 'multiplayerData';\n            return JSON.parse(sessionStorage.getItem(sessionKey));\n        }\n    }]);\n\n    return Data;\n}();\n\nasync function getDataFromApi() {\n    var response = await _axios2.default.get('https://thevideogameapi.azurewebsites.net/v1/mass-effect-3');\n    return response;\n}\n\nexports.default = Data;\n\n//# sourceURL=webpack:///./helpers/data.js?");
